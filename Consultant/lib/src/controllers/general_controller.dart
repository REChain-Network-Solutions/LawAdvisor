...
import 'package:lawyer_consultant/src/models/all_services_model.dart';
...
//-----------------------------selected Appointment History for detail view
  CustomerBookedServiceModel selectedBookedServiceForView =
      CustomerBookedServiceModel();
  updateSelectedBookedServicesForView(
    CustomerBookedServiceModel newValue,
  ) {
