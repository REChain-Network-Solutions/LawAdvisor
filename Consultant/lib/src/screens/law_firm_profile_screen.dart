        ...
        appBar: PreferredSize(
          ...
          child: AppBarWidget(
            richTextSpan: TextSpan(
              text: LanguageConstant.lawFirmProfile.tr,
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Text(
                      LanguageConstant.associatedLawyers.tr,
                        ...
                        Theme(
                          ...
                          child: TabBar(
                            ...
                            indicator: BoxDecoration(
                                ...
                                borderRadius: BorderRadius.circular(10)),
                            tabs: [
                              Tab(text: LanguageConstant.about.tr),
                              Tab(text: LanguageConstant.reviews.tr),
                            ],
                          ),
                        ),
                        Container(
                            ...
                            child: TabBarView(children: <Widget>[
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                        '${LanguageConstant.about.tr} ${generalController.selectedLawFirmForView.name}',
                                        style: AppTextStyles.bodyTextStyle2),
