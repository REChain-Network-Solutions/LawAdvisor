...
class LiveServiceChatScreen extends StatefulWidget {
  const LiveServiceChatScreen({super.key});
    ...
    try {
      ...
      final myChannel = pusherChannels.subscribe(
          ...
          onEvent: (event) {
            ...
            log("Got channel event messageData: ${Get.find<LiveChatController>().getLiveServiceChatMessagesModel}");

            log("${Get.find<LiveChatController>().serviceMessageList} 333");
            ...
            log("${Get.find<LiveChatController>().serviceMessageList.length} length");
          });
            ...
            appBar: PreferredSize(
              ...
              child: AppBarWidget(
                ...
                richTextSpan: TextSpan(
                  text:
                      generalController.selectedBookedServiceForView.lawyerName,
