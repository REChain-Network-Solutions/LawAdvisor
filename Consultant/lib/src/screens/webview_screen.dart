...
import 'package:lawyer_consultant/src/routes.dart';
...
class WebViewScreen extends StatefulWidget {
  ...
  const WebViewScreen({super.key, required this.urlEndPoint, this.fromScreen});
          ...
          onPageFinished: (String url) {
            ...
            setState(() {
              ...
              if (currentURL.toString().split("/").last.toString() ==
                ...
                } else if (widget.fromScreen == "Service Screen") {
                  Future.delayed(const Duration(seconds: 5), () {
                    if (widget.fromScreen == "Service Screen") {
                      Get.offAndToNamed(PageRoutes.bookedServicesScreen,
                          parameters: {"fromBookService": "Yes"});
                    } else {
                      Get.offAndToNamed(PageRoutes.walletScreen,
                          parameters: {"fromWebView": "Yes"});
                    }
...
Page resource error:
  ...
  isForMainFrame: ${error.isForMainFrame}
          ...
          onNavigationRequest: (NavigationRequest request) {
            if (request.url
                .startsWith("${webViewPaymentURL}/${widget.urlEndPoint}")) {
      ...
      ..loadRequest(Uri.parse("${webViewPaymentURL}/${widget.urlEndPoint}"));
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBarWidget(
          ...
          leadingOnTap: () async {
            if (currentURL.toString().split("/").last.toString() == "success") {
              if (widget.fromScreen == "Appointment Screen") {
                if (widget.fromScreen == "Appointment Screen") {
                  Get.offAndToNamed(PageRoutes.appointmentHistoryScreen,
                      parameters: {"fromBookAppointment": "Yes"});
