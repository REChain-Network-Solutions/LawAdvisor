...
// class LawyerBlogsListWidget extends StatefulWidget {
//   final String lawyerBlogsSlug;
//   LawyerBlogsListWidget({
//     super.key,
//     required this.lawyerBlogsSlug,
//   });

//   @override
//   State<LawyerBlogsListWidget> createState() => _LawyerBlogsListWidgetState();
// }

// class _LawyerBlogsListWidgetState extends State<LawyerBlogsListWidget> {
//   final logic = Get.put(LawyerReviewsController());

//   @override
//   void initState() {
//     super.initState();
//     postMethod(context, '$getLawyerReviews/${widget.lawyerBlogsSlug}', null,
...
//                               children: [
//                                 Text(
//                                   "${lawyerReviewsController.getLawyerReviewsModel.data!.data![index].customer!.name}",
...
//                                             "${lawyerReviewsController.getLawyerReviewsModel.data!.data![index].createdAt?.split(",").first}",
//                                             textAlign: TextAlign.start,
