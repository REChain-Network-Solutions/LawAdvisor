                ...
                <div class="accordion border-0 p-0" id="accordionExample">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <div class=" ">
                          <div class="fs-5 fw-bold mb-0 ms-4">{{ __(day.name )}}</div>
                        </div>
                      </div>
                      <button
...
export default defineComponent({
    ...
    methods: {
        getAppointmentschedules() {
            ...
            axios
                .get(
                    this.route("law_firm.getApiAppointmentSchedules", {
        ...
        submit() {
            this.form.post(this.route("law_firm.save_appointment_schedules"), {
                onSuccess: () => {
        ...
        deleteSelectDaySlots(day_value, model_id) {
            ...
            this.deleteForm.post(
                this.route("law_firm.delete_appointment_slots"),
                {
                    onSuccess: () => {
        ...
        addSelectDaySlots(day_value, model_id) {
            ...
            this.addForm.post(
                this.route("law_firm.add_new_appointment_schedules"),
                {
                    onSuccess: () => {
                        document.getElementById(model_id).click();
                        this.addForm.day = "";
