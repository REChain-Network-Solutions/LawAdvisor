      ...
      <div class="col-12">
        <div class="row">
            <div class="col-12">
                ...
                <div class="form-group mb-4">
                  <div class="form-floating">
                  <input id="zip_code" class="form-control border border-primary"  :placeholder="__('zip code')"
                ...
                <div class="form-group mb-4">
                  ...
                  :placeholder="__('email address')" type="email" v-model="form.email" />
                ...
                <div class="form-group mb-4">
                  <div class="form-floating">
                  <input id="pass_log_log" class="form-control border border-primary" type="password"
                    v-model="form.password_confirmation" name="password_confirmation"  :placeholder="__('confirm password')">
                    <label class="text-muted"  for="floatingInput">{{ __('confirm password') }}</label>
                </div>
                    <span toggle="#password-field"
                    class="fa fa-fw fa-eye field_icon toggle-password-log position-absolute input-icon fs-5"></span>
                </div>
            ...
            <div class="col-12 mb-3">
                <div class="form-check">
                  <div v-if="this.errors.terms" class="error-validation text-end">
                    ...
                    <label class="form-check-label" style="font-size: 14px;" for="flexCheckDefault">
                    {{ __('terms changes') }}
                        <a :href="route('company_pages.display',{slug:'terms'})" target="_blank">{{ __('terms of use') }} &{{ __('condition') }} </a>

                        {{ __('and the') }}<a :href="route('company_pages.display',{slug:'privacy'})" target="_blank"> {{ __('privacy policy') }}</a>
                    </label>
                </div>
            </div>
          <div class="col-md-4">
