                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="d-flex mb-3 d-flex mb-3 justify-content-center card-avatar overflow-hidden position-relative" style="height: 150px">
                            <img v-if="service.customer_image" class="img-fluid" :src="service.customer_image" alt="lawyer" />
                            ...
                            <div class="card-body p-0">
                                <div class="row">
                                    ...
                                    <div class="col-md-4 text-end">
                                        <Link :href="route('law_firm.service_log.detail',{id:service.id})" class="btn btn-outline-primary fw-bold px-3 shadow-sm mb-3 rounded">
                                        {{ __("view details") }}
                                        </Link>
<!--
