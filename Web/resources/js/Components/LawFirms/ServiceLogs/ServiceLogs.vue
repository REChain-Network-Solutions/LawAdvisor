        ...
        <div class="row mx-0 border-bottom border-dark py-5">
            <div class="col-12 text-center">
                <p class="fs-2 mb-0">
                    ...
                    <span class="fw-bold">{{ __("service history") }}</span>
                </p>
            ...
            <div class="row">
                ...
                <div class="col-md-9 border-start border-dark">
                    <div class="tab-content w-100 p-4" id="v-pills-tabContent">
                        <div v-for="(status, index) in service_statuses" :key="index" class="tab-pane fade" :class="{
                                            ...
                                            <div class="d-md-flex align-items-center justify-content-end mb-3">
                                                <div class="form-group me-2 mb-3 mb-md-0">
                                                    <select style="width: 200px" v-model="filter.column"
                                                        ...
                                                        <option v-for="col in this
                                                            .columns" :key="col.id" :value="col.value">{{
        col.name }}</option>
                                                    </select>
                                                </div>
                                        ...
                                        <law-firm-service-list-card
                                            :services="services"></law-firm-service-list-card>
                                        <div class="col-12">
...
import LawFirmServiceListCard from "@/Components/LawFirms/ServiceLogs/LawFirmServiceListCard.vue";
...
export default defineComponent({
    ...
    data() {
        return {
            ...
            columns: [
                {
                    "id": 1,
                    'name': this.__('law_firm'),
                    'value': "law_firm.first_name",
                    'searchable': false,
                    'sortable': false
                },
                {
    ...
    methods: {
        ...
        getServiceFilterData(loading_more) {
            this.fetching = true
            axios.post(this.route('getApiLawFirmsFilterServiceLogs'), this.filter).then(res => {
