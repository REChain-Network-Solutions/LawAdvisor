<template>
  <div
    class="tab-pane"
    :class="{ active: active }"
    id="lawyer-register-pane"
    role="tabpanel"
    aria-labelledby="lawyer-register-pane"
    tabindex="0"
  >
          ...
          <div class="col-12">
            ...
            <div class="form-group mb-4">
              ...
              <span
                ...
                class="fa fa-fw fa-eye field_icon toggle-password-log position-absolute input-icon fs-5"
              ></span>
            </div>
