                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div v-if="currentTab === index">
                                        ...
                                        <lawyer-service-list-card
                                            :services="services"></lawyer-service-list-card>
                                        <div class="col-12">
...
import LawyerServiceListCard from "@/Components/Lawyers/ServiceLogs/LawyerServiceListCard.vue";
...
export default defineComponent({
    ...
    methods: {
        ...
        getServiceFilterData(loading_more) {
            this.fetching = true;
            axios
                .post(this.route("getApiLawyerFilterServiceLogs"), this.filter)
                .then(res => {
