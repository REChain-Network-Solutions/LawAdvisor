<template>
    <app-layout title="Quick by Services">
        <section class="quickbyservices">
                        ...
                        <div class="col-md-3">
                            <div class="d-flex align-items-center flex-column">
                                <div class="avatar overflow-hidden mb-3 rounded-lg bg-light">
                                    <img v-if='service.image' style="width: 100%;" :src="service.image" alt="ServiceImage">
                                    <img v-else style="width: 100%;" src="@/images/common/avatar.png" alt="Avatar">

                                </div>
                                <div v-if="service.lawyer">
                                    <p>Service by:
                                        <span class="fw-bold">{{ service.lawyer.name }}</span>
                                    </p>
                                    <!-- <Link :href="route('lawyer.profile', { user_name: service.lawyer.user_name })" class="btn rounded-pill btn-primary">
                                        View Profile
                                    </Link> -->
                                </div>
                                <div v-if="service.law_firm">
                                    <p>service by:
                                        <span class="fw-bold">{{ service.law_firm.name }}</span>
                                    </p>
                                    <Link :href="route('law_firm.profile', { user_name: service.law_firm.user_name })" class="btn rounded-pill btn-primary">
                                        View Profile
                                    </Link>
                                </div>
                            </div>
                        ...
                        <div class="col-md-9">
                            <div class="d-flex align-items-start justify-content-center flex-column px-4">
                                ...
                                <div class="d-flex rounded-4 w-100 p-1 mb-4 justify-content-between align-items-center"
                                    ...
                                    <Link :href="route('book_service_display',{service:service.slug})" class="btn btn-primary fw-bold px-4 me-1">buy now</Link>
                                </div>

                                <div class="d-flex w-100 justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <span class="me-2 d-flex">
                                            <span class="overflow-hidden d-flex border border-light rounded-circle" style="height: 40px; width: 40px; margin-right: -30px;"><img src="@/images/lock.png" alt="Image"></span>
                                            <span class="overflow-hidden d-flex border border-light rounded-circle" style="height: 40px; width: 40px;"><img src="@/images/lock.png" alt="Image"></span>
                                        </span>
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="card rounded-lg">
                                <div class="card-body">
                                    <div class="d-flex align-items-center flex-column justify-content-center pt-3">
                                        <div class="mb-3">
                        ...
                        <div class="col-md-4">
                            <div class="card rounded-lg">
                                <div class="card-body">
                                    <div class="d-flex align-items-center flex-column justify-content-center">
                                        <div class="mb-3">
                                            <img src="@/images/paisa.png" alt="Icon">
                                        </div>
            ...
            <div class="py-5" v-if="service.law_firm">
                <div class="container">
                    <div class="row">
                        <div class="col-md-7">
                            <h2>{{ service.law_firm.name }}</h2>
                            <p v-html="service.law_firm.description"></p>
                        </div>
                        <div class="col-md-5 text-end">
                            <img v-if="service.law_firm.image" :src="service.law_firm.image" class="rounded-4" alt="Image">
                            <img v-else src="@/images/sale-services.png" class="rounded-4" />
                        </div>
                    </div>
                </div>
            ...
            <div class="py-5" v-if="service.faqs.length > 0" style="background-image: url('@/images/queries-bg.png'); background-color: black;">
                <div class="container">
                    <div class="row">
